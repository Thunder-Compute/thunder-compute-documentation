...
<Columns cols={3}>
  ...
  <Card title="CLI" icon="terminal" color="#4476a8" href="/cli/operations/monitoring-instances">
    Command line
  </Card>
  <Card title="Console" icon="browser" href="/console/operations/monitoring-instances">
    Web interface
  </Card>
</Columns>
