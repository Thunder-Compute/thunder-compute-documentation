...
description: 'Manual SSH setup is only available in the Thunder Compute Console. Use the console to manage saved keys and copy raw SSH connection details.'
icon: "key"
iconType: "solid"
...
Manual SSH setup is not available in the CLI. To save SSH keys, attach them to instances, or copy raw SSH connection details, use the [console SSH workflow](/console/operations/ssh).

For the standard CLI connection flow, use [Connect to Instances](/cli/operations/connecting-to-instances).
