...
Your credentials are saved to `~/.thunder/token`.
...
1. **Environment variable**: Set `TNR_API_TOKEN` in your shell (takes precedence)
2. **Token file**: Save your API token to `~/.thunder/token`
