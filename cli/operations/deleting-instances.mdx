...
<Columns cols={3}>
  ...
  <Card title="CLI" icon="terminal" color="#95c5ea" href="/cli/operations/deleting-instances">
    Command line
  </Card>
  <Card title="Console" icon="browser" color="#3a6289" href="/console/operations/deleting-instances">
    Web interface
  </Card>
</Columns>
