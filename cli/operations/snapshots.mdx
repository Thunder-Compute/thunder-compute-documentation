...
<Columns cols={3}>
  <Card title="VSCode / Cursor" icon="window" color="#3a6289" href="/vscode/operations/snapshots">
    Editor extension
  </Card>
  <Card title="CLI" icon="terminal" color="#95c5ea" href="/cli/operations/snapshots">
    Command line
  </Card>
