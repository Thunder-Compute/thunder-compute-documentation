...
<Columns cols={3}>
  ...
  <Card title="CLI" icon="terminal" color="#4476a8" href="/cli/operations/creating-instances">
    Command line
  </Card>
  <Card title="Console" icon="browser" href="/console/operations/creating-instances">
    Web interface
  </Card>
</Columns>
