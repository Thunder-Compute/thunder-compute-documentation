...
<Columns cols={3}>
  <Card title="VSCode / Cursor" icon="window" color="#4476a8" href="/vscode/quickstart">
    Editor extension
  </Card>
  <Card title="CLI" icon="terminal" href="/cli/quickstart">
    Command line
  </Card>
  <Card title="Console" icon="browser" href="/console/quickstart">
    Web interface
  </Card>
</Columns>
...
If not, open the command palette with `Ctrl + Shift + P` (or `Cmd + Shift + P` on macOS) and run `Thunder Compute: Login`
