...
Manual SSH setup is not available in the VS Code extension. To save SSH keys, attach them to instances, or copy raw SSH connection details, use the [console SSH workflow](/console/operations/ssh).

For the standard VS Code connection flow, use [Connect to Instances](/vscode/operations/connecting-to-instances).
