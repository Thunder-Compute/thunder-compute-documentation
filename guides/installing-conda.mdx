...
1. Create a new instance by following the steps in the [Quickstart Guide](https://www.thundercompute.com/docs/quickstart) and connect to it. You can also use our [VSCode integration](/guides/vscode-integration-for-thunder-compute) for a better development experience.
