...
<Warning>
  **Important Change:** Starting October 8, 2025, all new Thunder Compute instances use ephemeral storage. This means instances can only be **created** and **deleted**, not started and stopped. All data is lost when an instance shuts down.
</Warning>
