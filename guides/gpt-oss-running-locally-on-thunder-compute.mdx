...
This command starts a 1 GPU instance with:

* **GPU:** A100 80 GB
* **vCPUs:** 4
* **Storage:** 200 GB (from the *Ollama* template)

> The GPU type, GPU count, and vCPU count can be changed later if your requirements change, and the amount of storage can be increased if needed.
