...
```bash
tnr create --mode development --gpu a6000 --vcpus 8 --template base --disk 200
```
...
```bash
# A100 80 GB
tnr create --mode development --gpu a100 --num-gpus 1 --vcpus 12 --template base --disk 250

# H100 80 GB
tnr create --mode development --gpu h100 --num-gpus 1 --vcpus 16 --template base --disk 250
```
