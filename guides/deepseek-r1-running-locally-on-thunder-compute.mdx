---
title: "Self-host Deepseek R1"
description: 'Self-host Deepseek R1 on Thunder Compute cloud GPUs. Local model deployment and configure hardware for optimized inference performance.'
mode: "wide"
