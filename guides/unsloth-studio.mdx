...
<Info>
  These commands were verified on a single A100 80 GB prototyping instance. The same setup path is suitable for other GPU instances with enough disk space for the models and datasets you plan to use.
</Info>
...
```bash
# RTX A6000
tnr create --mode prototyping --gpu a6000 --num-gpus 1 --vcpus 6 --template base --primary-disk 250
