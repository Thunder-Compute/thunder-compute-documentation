...
### Connect to VSCode
Follow the instructions in our [Using Thunder Compute with VSCode](https://thundercompute.com/docs/guides/vscode-integration-for-thunder-compute) to set up your remote instance in VSCode.
