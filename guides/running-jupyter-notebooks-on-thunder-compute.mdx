...
Follow the instructions in our [Using Thunder Compute with VSCode](https://www.thundercompute.com/docs/guides/vscode-integration-for-thunder-compute) guide to set and connect to a remote instance in VSCode.
