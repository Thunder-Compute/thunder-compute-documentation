...
Navigate to the Remote Explorer on the left sidebar in VSCode. You should see your instance listed as `tnr-0`. If you just created your instance, you may have to connect to it with the command `$ tnr connect <instance_id>` to add it to Remote Explorer.
