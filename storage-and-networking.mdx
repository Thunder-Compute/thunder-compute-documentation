...
If you’re using the CLI, you can tunnel ports with the connect modifier -t. Using port 6006 as an example, you could run: `tnr connect <instance ID> -t 6006` 

Then access on your browser at http://localhost:6006/ use something like cloudflared: `cloudflared tunnel --url http://localhost:6006`

If you’re using the vscode extension, you can forward ports once you have connected to an instance. To do this, use the bottom tab of vscode under “ports,” shown [here](https://code.visualstudio.com/docs/debugtest/port-forwarding).
