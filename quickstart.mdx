  ...
  <Tab title="CLI">
    <Tabs>
      <Tab title="Windows">
        ...
        Download the installer for x64 from [here (most common)](https://gettnr.com/tnr/releases/latest/windows/tnr_windows_amd64.msi) or for ARM64 from [here](https://gettnr.com/tnr/releases/latest/windows/tnr_windows_arm64.msi) and run the .msi file.
      ...
      <Tab title="MacOS">
        ...
        Download the installer for Apple Silicon (ARM64) from [here (most common)](https://gettnr.com/tnr/releases/latest/macos/tnr_darwin_arm64.pkg) or the Intel x64 from [here](https://gettnr.com/tnr/releases/latest/macos/tnr_darwin_amd64.pkg) and run the .pkg file.
...
- Learn about [Prototyping Mode](/docs/prototyping-mode) vs [Production Mode](/docs/production-mode) to choose the right tier for your workload
- Explore [Technical Specifications](/docs/technical-specs) for hardware, networking, and storage details
- Check the [CLI Reference](/docs/cli-reference) for advanced commands
