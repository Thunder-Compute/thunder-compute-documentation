...
All compute resources are billed per minute only while your instances run. This includes time spent starting, stopping, or deleting. Storage incurs charges even when instances are stopped. Rates and promotions are subject to change without notice. For current rates, see our [pricing page](https://www.thundercompute.com/pricing).
