...
Save a credit card through our Stripe portal to get automatically billed for usage. You can manage your payment method anytime by going to [console.thundercompute.com/settings?tab=billing](https://console.thundercompute.com/settings?tab=billing) and clicking "manage billing".
