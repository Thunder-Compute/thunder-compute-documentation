---
title: "CLI Reference"
description: "Comprehensive reference for the Thunder Compute CLI (\`tnr\`). Manage instances (create, start, stop, delete), configure GPUs/CPUs, handle files, and use snapshots."
icon: "bolt"
iconType: "solid"
---
