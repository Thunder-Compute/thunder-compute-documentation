...
Authenticate the CLI, which provides a link to the [console](https://console.thundercompute.com/settings/tokens) where you can generate an API token.
...
- Generate/manage tokens in the [console](https://console.thundercompute.com/settings/tokens)
...
<Note>
By default, 4 vCPUs are included with your instance. Additional vCPUs are billed hourly at the rates shown [here](https://thundercompute.com/pricing)
</Note>
...
<Note>Stopped instances continue to accrue storage cost.</Note>
