...
Mining, staking, or otherwise interacting with cryptocurrency protocols is strictly prohibited on Thunder Compute. If cryptocurrency-related activity is detected, you will be banned from Thunder Compute. GPU, CPU, or storage usage related to cryptocurrency is not eligible for the monthly billing credit and you will be billed for the full amount of your usage. 
