...
Thunder Compute is optimized for AI/ML development workflows. That said, Thunder Compute has the full functionality of an EC2 instance. To understand how this works, check out our [technical background](/docs/background).
