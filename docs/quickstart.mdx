---
title: "Quickstart"
description: "We offer two ways to access your Thunder Compute instances: a CLI tool and a VSCode extension. To quickly launch templates, we recommend the CLI. To develop with full access to files on the instance, we recommend the VSCode extension"
icon: "rocket"
iconType: "solid"
mode: "wide"
---
...
<Tabs>
  <Tab title="VSCode / Cursor (Recommended)">
    ...
    Get the Thunder Compute extension for [VSCode](vscode:extension/ThunderCompute.thunder-compute) or [Cursor](cursor:extension/ThunderCompute.thunder-compute)
