---
title: "Quickstart"
description: "We offer two ways to access your Thunder Compute instances: a CLI tool and a VSCode extension. To develop with full access to files on the instance, we recommend the VSCode extension. To quickly launch templates, use the CLI. "
icon: "rocket"
iconType: "solid"
mode: "wide"
---
...
<Tabs>
  <Tab title="VSCode / Cursor (Recommended)">
    ...
    Click the following link to install the Thunder Compute [VSCode extension](vscode:extension/ThunderCompute.thunder-compute) or [Cursor extension](cursor:extension/ThunderCompute.thunder-compute)
