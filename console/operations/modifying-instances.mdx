...
description: 'Update instance configurations in the Thunder Compute Console. ASwap GPUs, add vCPUs and RAM, or increase storage space for your compute resources.'
icon: "sliders"
iconType: "solid"
---
