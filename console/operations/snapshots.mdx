...
Snapshotting happens in the background, so you can continue using your instance immediately. The snapshot captures the exact state at the moment you initiated it.
