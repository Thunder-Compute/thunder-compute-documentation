...
description: "Ask your AI agent to create Thunder Compute instances, or switch to another interface for direct control."
icon: "plus"
iconType: "solid"
---
...
<Columns cols={4}>
  ...
  <QuickstartCard title="MCP Server" icon="robot" href="/mcp-server/operations/creating-instances" selected={true}>
    MCP server
  </QuickstartCard>
</Columns>
