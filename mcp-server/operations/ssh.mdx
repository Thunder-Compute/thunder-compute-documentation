...
description: "Ask your AI agent to work through Thunder Compute over MCP, or switch to the console for manual SSH control."
icon: "key"
iconType: "solid"
...
<Columns cols={4}>
  ...
  <QuickstartCard title="MCP Server" icon="robot" href="/mcp-server/operations/ssh" selected={true}>
    MCP server
  </QuickstartCard>
</Columns>

Ask your agent in natural language. For manual SSH setup or raw connection details, use the [console SSH workflow](/console/operations/ssh).
