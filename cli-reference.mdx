---
title: "CLI Reference"
description: "Comprehensive reference for the Thunder Compute CLI. Manage instances (create, delete), configure GPUs/CPUs, handle files, and use snapshots."
icon: "bolt"
iconType: "solid"
---
...
<Note>
  Instance storage is ephemeral. Back up important data externally or create a snapshot before you delete an instance. See [Using Ephemeral Storage](/guides/using-ephemeral-storage) for recommended workflows.
</Note>
...
Snapshots capture the state of an instance's disk so you can create new instances from that point in time. For a detailed guide on using snapshots, including how to create them from the console, see our [Using Snapshots guide](/guides/using-snapshots).
...
<Warning>
  ...
  create a new instance and transfer your files before deleting the original.
</Warning>
