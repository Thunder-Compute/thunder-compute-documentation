...
For persistent SSH issues, see our [SSH on Thunder Compute guide](/console/operations/ssh) for alternative connection methods.
...
If you continue to experience compatibility issues or errors that cannot be resolved through the above methods, try resizing the instance or contact support with the failing command and logs.
